...
public class UtopiaPoint {
    ...
    public UtopiaPoint(String configFilePath){
    ...
    private void initFromConfigFile(String configFilePath){
        ...
        OUTPUT_FILE = props.getProperty("UTOPIA_OUTPUT_FILE");
        ...
        Double val, minimum, costSum=0.0, timeSum=0.0;
        ...
        String npoint = "Utopia point (cost,time):\n" + costSum + "," + timeSum + "\n";
        System.out.println("\n\n"+npoint);
    ...
    public static void main (String[] args){
        if(args.length != 1){
            ...
            UtopiaPoint m = new UtopiaPoint(args[0]);
        }
    }
}
